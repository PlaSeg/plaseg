            ...
            <div className="p-6 ">
                <div className="bg-white border p-6 rounded-lg mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <InputField label="Nome da Ata" type="text" placeholder="Digite o nome da Ata" />
                        <InputField label="Número da Ata" type="text" placeholder="Digite o número da Ata" />
                        <InputField label="Ano da Ata" type="text" placeholder="Digite o ano da Ata" />
                        <InputField label="Órgão Responsável" type="text" placeholder="Digite o órgão responsável" />
                        <InputField label="Fornecedor" type="text" placeholder="Digite o fornecedor" />
